...
def test_network_DA_algorithm(examples_datasets_train, labels_datasets_train, num_neurons, feature_vector_input_length,
                              path_weights_normal='../weights', path_weights_DA='../weights_DANN', algo_name="DANN",
                              cycle_to_test=None, gestures_to_remove=None, number_of_classes=11):
...
if __name__ == "__main__":
    ...
    test_network_DA_algorithm(examples_datasets_train, labels_datasets_train,
                              ...
                              cycle_to_test=3)
    '''
    algo_name = "VADA_THREE_CYCLES_11Gestures_TSD"
    ...
    train_DA_spectrograms(examples_datasets_train, labels_datasets_train, filter_size=None,
                          ...
                          gestures_to_remove=gestures_to_remove, number_of_classes=number_of_class,
                          number_of_cycle_for_first_training=number_of_cycle_for_first_training,
                          number_of_cycles_rest_of_training=number_of_cycles_rest_of_training, spectrogram_model=False,
                          feature_vector_input_length=feature_vector_input_length,
                          path_weights_to_save_to="Weights_TSD/weights_", learning_rate=learning_rate)
    '''
    test_network_DA_algorithm(examples_datasets_train, labels_datasets_train,
                              ...
                              cycle_to_test=3)
    '''
    algo_name = "Dirt_T_THREE_CYCLES_11Gestures_TSD"
    train_DA_spectrograms(examples_datasets_train, labels_datasets_train, filter_size=None,
                          num_kernels=num_neurons,
                          algo_name=algo_name,
                          path_weights_to_load_from_for_dirtT='Weights_TSD/weights_VADA_THREE_CYCLES_11Gestures_TSD',
                          path_weights_fine_tuning=path_weights_fine_tuning,
                          gestures_to_remove=gestures_to_remove, number_of_classes=number_of_class,
                          number_of_cycle_for_first_training=number_of_cycle_for_first_training,
                          number_of_cycles_rest_of_training=number_of_cycles_rest_of_training, spectrogram_model=False,
