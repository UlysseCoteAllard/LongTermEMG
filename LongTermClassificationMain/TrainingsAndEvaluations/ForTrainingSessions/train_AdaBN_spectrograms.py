...
def test_network_AdaBN_algorithm(examples_datasets_train, labels_datasets_train, num_kernels,
                                 path_weights_normal='../weights', path_weights_DA='../Weights/weights_AdaBN',
                                 filter_size=(4, 10), algo_name="AdaBN", cycle_to_test=None,
...
if __name__ == "__main__":
    ...
    algo_name = "AdaBN_THREE_CYCLES_11Gestures_Spectrogram"

    train_AdaBN_spectrograms(examples_datasets_train, labels_datasets_train, filter_size=filter_size,
                             ...
                             batch_size=128)
    '''
    test_network_AdaBN_algorithm(examples_datasets_train, labels_datasets_train, num_kernels=num_kernels,
                                 filter_size=filter_size, path_weights_DA='../Weights/weights_' + algo_name,
                                 algo_name=algo_name,
