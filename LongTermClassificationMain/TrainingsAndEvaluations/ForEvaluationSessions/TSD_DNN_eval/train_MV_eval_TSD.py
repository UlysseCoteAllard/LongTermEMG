...
from LongTermClassificationMain.TrainingsAndEvaluations.self_learning.self_learning_utils import \
    generate_dataloaders_for_MultipleVote_Evaluation
...
def run_MV_evaluation_sessions(examples_datasets_evaluations, labels_datasets_evaluation,
                               examples_datasets_train, labels_datasets_train, algo_name,
                               num_neurons, path_weights_to_load_from, path_weights_SCADANN, learning_rate,
    ...
    participants_train, _, _ = load_dataloaders_training_sessions_spectrogram(
        ...
        ignore_first=True, shuffle=False)
    ...
    for participant_i in range(len(participants_evaluation_dataloader)):
        ...
        for session_j in range(0, len(participants_evaluation_dataloader[participant_i])):
            ...
            if session_j % 2 == 0:
                ...
                train_dataloader_pseudo, validationloader_pseudo = generate_dataloaders_for_MultipleVote_Evaluation(
                ...
                best_state = train_model_standard(model=model, criterion=crossEntropyLoss,
                                                  ...
                                                  patience_increase=patience_increment)
                if use_recalibration_data:
...
if __name__ == "__main__":
    ...
    path_weights_MV = "Weights_TSD_eval/weights_"
    algo_name = "MV_TSD_FirstEvaluation"

    # Using weights learned by normal classifier
    run_MV_evaluation_sessions(examples_datasets_evaluations=examples_datasets_evaluation,
                               labels_datasets_evaluation=labels_datasets_evaluation,
                               examples_datasets_train=examples_datasets_train,
                               labels_datasets_train=labels_datasets_train, num_neurons=num_neurons,
                               path_weights_to_load_from=path_weights_fine_tuning,
                               algo_name=algo_name, path_weights_SCADANN=path_weights_MV,
                               batch_size=512, patience_increment=10, use_recalibration_data=False,
                               number_of_cycle_for_first_training=4, number_of_cycles_rest_of_training=4,
    ...
    test_network_convNet_only_second_evaluation_session_for_each_training_session(
        ...
        dnn=TSD_Network,
        num_neurons=num_neurons, path_weights=path_weights_MV,
